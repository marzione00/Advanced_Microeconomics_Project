...
geom_vline(xintercept = 27, linetype="dashed", color = "orange", size=1)+ 
geom_vline(xintercept = 28, linetype="dashed", color = "red", size=1)+
geom_vline(xintercept = 29, linetype="dashed", color = "orange", size=1)+ 
geom_vline(xintercept = 30, linetype="dashed", color = "darkgreen", size=1)+
