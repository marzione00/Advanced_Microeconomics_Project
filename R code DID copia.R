...
#Articoli Sportivi
ProduzioneArticoliSportivi_READY <- read_excel("/Users/MacBook/Documents/University of Milan/Progetto Micro/ProduzioneArticoliSportivi_READY.xlsx")
ProduzioneArticoliSportivi_READY$delta<-ProduzioneArticoliSportivi_READY$Alimentari-ProduzioneArticoliSportivi_READY$Sport
ggplot(data=ProduzioneArticoliSportivi_READY,aes(x=Data,y=Alimentari))+geom_line(size=2,color = "red")+geom_line(size=2,aes(x=Data,y=Sport),color = "blue")+
  geom_line(size=2,color = "red")+geom_line(size=2,aes(x=Data,y=delta),color = "green")

Sport <- read_excel("/Users/MacBook/Documents/University of Milan/Progetto Micro/Produzione Articoli Sportivi")
did9 <-lm(Alimentari ~  C + Time + Time2+Time3 + C*Time +C*Time2+C*Time3, data = Sport)
summary(did9)

#PRODUZIONE GIOIELLERIA
ProduzioneGioielleria321_READY <- read_excel("/Users/MacBook/Documents/University of Milan/Progetto Micro/ProduzioneGioielleria321_READY.xlsx")
ProduzioneGioielleria321_READY$delta<-ProduzioneGioielleria321_READY$Alimentari-ProduzioneGioielleria321_READY$Gioielleria
ggplot(data=ProduzioneGioielleria321_READY,aes(x=Data,y=Alimentari))+geom_line(size=2,color = "red")+geom_line(size=2,aes(x=Data,y=Gioielleria),color = "blue")+
  geom_line(size=2,color = "red")+geom_line(size=2,aes(x=Data,y=delta),color = "green")

Gioielleria <- read_excel("/Users/MacBook/Documents/University of Milan/Progetto Micro/Produzione Gioielleria")
did10 <-lm(Alimentari ~  C + Time + Time2+Time3 + C*Time +C*Time2+C*Time3, data = Gioielleria)
summary(did10)

#PRODUZIONE STRUMENTI MUSICALI

Strumentimusicali_READY <- read_excel("/Users/MacBook/Documents/University of Milan/Progetto Micro/Strumentimusicali_READY.xlsx")
Strumentimusicali_READY$delta<-Strumentimusicali_READY$Alimentari-Strumentimusicali_READY$Strummusicali
ggplot(data=Strumentimusicali_READY,aes(x=Data,y=Alimentari))+geom_line(size=2,color = "red")+geom_line(size=2,aes(x=Data,y=Strummusicali),color = "blue")+
  geom_line(size=2,color = "red")+geom_line(size=2,aes(x=Data,y=delta),color = "green")

Strummusicali <- read_excel("/Users/MacBook/Documents/University of Milan/Progetto Micro/Prod Strumenti musicali")
did11 <-lm(Alimentari ~  C + Time + Time2+Time3 + C*Time +C*Time2+C*Time3, data = Strummusicali)
summary(did11)

#PRODUZIONE GIOCHI

ProdGiochi_READY <- read_excel("/Users/MacBook/Documents/University of Milan/Progetto Micro/ProdGiochi_READY.xlsx")
ProdGiochi_READY$delta<-ProdGiochi_READY$Alimentari-ProdGiochi_READY$Giochi
ggplot(data=ProdGiochi_READY,aes(x=Data,y=Alimentari))+geom_line(size=2,color = "red")+geom_line(size=2,aes(x=Data,y=Giochi),color = "blue")+
  geom_line(size=2,color = "red")+geom_line(size=2,aes(x=Data,y=delta),color = "green")

Giochi <- read_excel("/Users/MacBook/Documents/University of Milan/Progetto Micro/ProduzioneGiochi")
did12 <-lm(Alimentari ~  C + Time + Time2+Time3 + C*Time +C*Time2+C*Time3, data = Giochi)
summary(did12)

#PRODUZIONE TESSILE

ProduzioneTessile_READY <- read_excel("/Users/MacBook/Documents/University of Milan/Progetto Micro/ProduzioneTessile_READY.xlsx")
ProduzioneTessile_READY$delta<-ProduzioneTessile_READY$Alimentari-ProduzioneTessile_READY$Abbigliamento
ggplot(data=ProduzioneTessile_READY,aes(x=Data,y=Alimentari))+geom_line(size=2,color = "red")+geom_line(size=2,aes(x=Data,y=Abbigliamento),color = "blue")+
  geom_line(size=2,color = "red")+geom_line(size=2,aes(x=Data,y=delta),color = "green")

Abbigliamento <- read_excel("/Users/MacBook/Documents/University of Milan/Progetto Micro/Produzione Tessile")
did13 <-lm(Alimentari ~  C + Time + Time2+Time3 + C*Time +C*Time2+C*Time3, data = Abbigliamento)
summary(did13)

#FABBRICAZIONE CALZATURE

FabbricazioneCalzature_READY <- read_excel("/Users/MacBook/Documents/University of Milan/Progetto Micro/FabbricazioneCalzature_READY.xlsx")
FabbricazioneCalzature_READY$delta<-FabbricazioneCalzature_READY$Alimentari-FabbricazioneCalzature_READY$Calzature
ggplot(data=FabbricazioneCalzature_READY,aes(x=Data,y=Alimentari))+geom_line(size=2,color = "red")+geom_line(size=2,aes(x=Data,y=Calzature),color = "blue")+
  geom_line(size=2,color = "red")+geom_line(size=2,aes(x=Data,y=delta),color = "green")

Calzature <- read_excel("/Users/MacBook/Documents/University of Milan/Progetto Micro/Fabbricazione Calzature")
did14 <-lm(Alimentari ~  C + Time + Time2+Time3 + C*Time +C*Time2+C*Time3, data = Calzature)
summary(did14)

#FABBRICAZIONE CERAMICA 

Fabbricazioneprodotticeramicaeporcellana180_READY <- read_excel("/Users/MacBook/Documents/University of Milan/Progetto Micro/Fabbricazioneprodotticeramicaeporcellana180_READY.xlsx")
Fabbricazioneprodotticeramicaeporcellana180_READY$delta<-Fabbricazioneprodotticeramicaeporcellana180_READY$Alimentari-Fabbricazioneprodotticeramicaeporcellana180_READY$Ceramica
ggplot(data=Fabbricazioneprodotticeramicaeporcellana180_READY,aes(x=Data,y=Alimentari))+geom_line(size=2,color = "red")+geom_line(size=2,aes(x=Data,y=Ceramica),color = "blue")+
  geom_line(size=2,color = "red")+geom_line(size=2,aes(x=Data,y=delta),color = "green")

Ceramica <- read_excel("/Users/MacBook/Documents/University of Milan/Progetto Micro/Fabbricazione prodotti ceramica e porcellana (no pavimenti) 180")
did15 <-lm(Alimentari ~  C + Time + Time2+Time3 + C*Time +C*Time2+C*Time3, data = Ceramica)
summary(did15)

#FABBRICAZIONE VETRO

FabbricazioneVetro_READY <- read_excel("/Users/MacBook/Documents/University of Milan/Progetto Micro/FabbricazioneVetro_READY.xlsx")
FabbricazioneVetro_READY$delta<-FabbricazioneVetro_READY$Alimentari-FabbricazioneVetro_READY$Vetro
ggplot(data=FabbricazioneVetro_READY,aes(x=Data,y=Alimentari))+geom_line(size=2,color = "red")+geom_line(size=2,aes(x=Data,y=Vetro),color = "blue")+
  geom_line(size=2,color = "red")+geom_line(size=2,aes(x=Data,y=delta),color = "green")

Vetro <- read_excel("/Users/MacBook/Documents/University of Milan/Progetto Micro/Fabbricazione Vetro")
did16 <-lm(Alimentari ~  C + Time + Time2+Time3 + C*Time +C*Time2+C*Time3, data = Vetro)
summary(did16)
