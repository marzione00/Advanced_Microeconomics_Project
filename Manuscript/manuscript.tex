...
\begin{figure}
     ...
     \begin{subfigure}[b]{0.45\textwidth}
         ...
         \caption{Redundancy funds paid for manufacture} 
     \end{subfigure}
     \hfill
     \begin{subfigure}[b]{0.45\textwidth}
         \centering
         \includegraphics[width=\textwidth]{Figures/CIG_Commercio.pdf}}
         \caption{Redundancy funds paid for trade}
     \end{subfigure}
          \begin{subfigure}[b]{0.45\textwidth}
         \centering
