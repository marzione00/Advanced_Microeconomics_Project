...
\begin{table}[]
\begin{center}
\caption{Sales value effects for the scenarios where an active vs lazy PM is considered (with the baseline $100=2015$).  These effects were calculated by running a DID regression for the different national lock-down imposed during March-June 2020 and then multiplying the number of lock-down weeks obtained from the SIRD scenario with the coefficients obtained from the DID (divided by 4).  The errors were calculated by considering the error propagation}
\begin{tabular}{l|l|l|l|l}
                & Active & \sigma   & Lazy &  \sigma \\ \hline
...
\begin{table}[]
\begin{center}
\caption{Redundancy funds variation(in terms of hours paid) for the scenarios where an active vs. lazy PM is considered. These effects were calculated by running a DID regression for the different national lock-down imposed during March-June 2020 and then multiplying the number of lock-down weeks obtained from the SIRD scenario with the coefficients obtained from the DID (scaled in order to obtain the week value). The errors  were calculated by considering the error propagation.}
\begin{tabular}{l|l|l|l|l}
             & Active &  \sigma  & Lazy &   \sigma  \\ \hline
