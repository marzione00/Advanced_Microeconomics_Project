...
\caption{
\begin{flushleft}
$\alpha$ , $\beta_{0}$ and $\beta_{1}$, expressed in millions, as obtained by the DID regression,  for subsidies  according to equation \ref{DID-eq} \\ for the different lock-down timings. 
\end{flushleft}
}
\begin{tabular}{l|l|l|l|l|l|l|l|l|l}
                                       & $\alpha$ &   $ \sigma_{\alpha}$   & t      & $\beta_{0}$ & $\sigma_{\beta_{0}}$ & t      &  $\beta_{1}$ & $\sigma_{\beta_{1}$  & t     \\ \hline
