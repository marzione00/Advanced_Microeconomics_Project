...
\begin{figure}
     ...
     \begin{subfigure}[b]{0.45\textwidth}
         ...
         \includegraphics[width=\textwidth]{Figures/CIG_TOT.pdf}}
          \caption{Total}
     \end{subfigure}
\caption{Comparison between the ordinary subsidies (blue)   vs. the extraordinary ones (renovation red and purple solidarity) for a selected set of sectors and the overall total (including other sectors that were not analysed here).  The dashed lines represent the different timing and intensity for the lock-down:  red for high, orange medium, and green for low.  }
